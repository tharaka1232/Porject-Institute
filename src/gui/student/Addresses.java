...
public class Addresses extends javax.swing.JDialog {
    ...
    public Addresses(Frame parent, String tableName1, Integer nic1, String name, String title, boolean modal) {
        super(parent, modal);
        initComponents();
        nic = nic1;
...
//        jComboBox2.setModel((DefaultComboBoxModel) new Onload().getComboData("city").get(1));
    ...
    private void loadData() {
        try {
            ...
            if (rs.next()) {
                jComboBox1.setSelectedItem(rs.getString("distric.name"));
